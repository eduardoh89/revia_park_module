...
import unidentifiedVehicleRoutes from './unidentifiedVehicle.routes';
import exceptionTypeTargetRoutes from './exceptionTypeTarget.routes';
...
router.use('/api/v1/unidentified-vehicles', unidentifiedVehicleRoutes);
router.use('/api/v1/exception-type-targets', exceptionTypeTargetRoutes);
